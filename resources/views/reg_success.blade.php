  ...
  <section id="register">
        <div class="container ">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Successfully registered!!!</h2>
                <p class="text-center wow fadeInDown"></p>
            </div>
            <div class="row">
                
                    <h2 class="text-center wow">Thank you for your participation</h2>
                    <div class="media service-box wow fadeInRight">
                        <p>

                          <li>
                            You will receive further correspondence by mail or phone...
                          </li>
                          <li>
                            <a href="{{ action('RegisterController@index') }}">Click here</a> to go back to home...
                          </li>
                        </p>
                    </div>
